...
model.add(Bidirectional(LSTM(200, return_sequences = True), input_shape = (200,1))) #성능개선을 위해 양방향 LSTM 추가
model.add(LSTM(200, activation='tanh')) # 100은 X 열과 맞춰줘야함 padding 필요 // LSTM(기사당 단어 수, 활성함수)
model.add(Dense(128,activation='tanh')) #Dense layer 입력과 출력을 연결해주는 선. 128은 그 선의 수 이며, 가중치의 수이기도하다.
